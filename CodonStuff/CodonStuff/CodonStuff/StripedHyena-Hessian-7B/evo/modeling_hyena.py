...
from evo.cache import InferenceParams
from evo.engine import HyenaInferenceEngine
from evo.layers import RMSNorm
from evo.utils import dotdict, column_split
...
class StripedHyenaModelForCausalLM(StripedHyenaPreTrainedModel):
    ...
    def forward(
        ...
        #print(f"The following are within the model -> input_ids: {input_ids}, attention_mask: {attention_mask}, labels: {labels}")
        if use_cache:
